...
#define LCD_BACK_H HAL_GPIO_WritePin(GPIOC, GPIO_PIN_2, 1)
#define LCD_BACK_L HAL_GPIO_WritePin(GPIOC, GPIO_PIN_2, 0)
...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD背光端口定义---------------- 
#define	LCD_BACK PCout(2)  //LCD背光    	PF10 	     


//使用NOR/SRAM的 Bank1.sector4,地址位HADDR[27,26]=11 
//A12作为数据命令区分线 
//注意设置时STM32内部会右移一位对其		    
#define  CMD_BASE       ((u32)(0x6C000000 | 0x0000007E))
#define  DATA_BASE      ((u32)(0x6C000000 | 0x00000080))
...
void LCD_FastDrawPoint(u16 x,u16 y,u16 color);	//快速画点
