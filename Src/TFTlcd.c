...
//	
//	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB|RCC_AHB1Periph_GPIOD|RCC_AHB1Periph_GPIOE|RCC_AHB1Periph_GPIOF|RCC_AHB1Periph_GPIOG|RCC_AHB1Periph_GPIOC, ENABLE);//??PD,PE,PF,PG??  
//  RCC_AHB3PeriphClockCmd(RCC_AHB3Periph_FSMC,ENABLE);//??FSMC??  
//	
// 
//	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2;//PB15 ????,????
//  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//??????
//  GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//????
//  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//100MHz
//  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//??
//  GPIO_Init(GPIOC, &GPIO_InitStructure);//??? //PB15 ????,????
//	
